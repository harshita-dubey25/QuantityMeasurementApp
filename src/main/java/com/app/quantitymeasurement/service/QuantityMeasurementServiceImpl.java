...
public class QuantityMeasurementServiceImpl implements IQuantityMeasurementService {
    ...
    public QuantityDTO convert(QuantityDTO thisQuantityDTO, QuantityDTO targetUnitDTO) {
        ...
        double result;
        if (source.getUnit() instanceof com.app.quantitymeasurement.unit.TemperatureUnit) {
            /*
    ...
    private IMeasurable getModelUnit(String measurementType, String unit) {
        switch (measurementType) {
            case "LengthUnit":
                return com.app.quantitymeasurement.unit.LengthUnit.valueOf(unit);
            case "WeightUnit":
                return com.app.quantitymeasurement.unit.WeightUnit.valueOf(unit);
            case "VolumeUnit":
                return com.app.quantitymeasurement.unit.VolumeUnit.valueOf(unit);
            case "TemperatureUnit":
                return com.app.quantitymeasurement.unit.TemperatureUnit.valueOf(unit);
            default:
